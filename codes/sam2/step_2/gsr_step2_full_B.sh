...
python inference.py \
  ...
  --fix_duplicate_track_ids --gpu_list 7 --max_processes_per_gpu 1 \
  --video_id_list 141,142,143,144,145,146,147,148,149,150,187,188,189,190,191,192,193,194,195,196,197,198,199,200
